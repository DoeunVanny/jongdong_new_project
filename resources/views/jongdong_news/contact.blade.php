                ...
                <div class="row">
                    <div class="col-4">
                        <div class="wrap-follow">
                            ...
                            <ul>
                                <li>
                                    <img src="{{ asset('assets/icon/fb.png') }}" width="40px"> <a href="">Facebook</a>
                                </li>
                                <li>
                                    <img src="{{ asset('assets/icon/yt.png') }}" width="40px"> <a href="">Youtube</a>
                                </li>
                                <li>
                                    <img src="{{ asset('assets/icon/ig.jfif') }}" width="40px"> <a href="">Instagram</a>
                                </li>
                                <li>
                                    <img src="{{ asset('assets/icon/telegram.png') }}" width="40px"> <a href="">Telegram</a>
                                </li>
                                <li>
                                    <img src="{{ asset('assets/icon/gmail-1.png') }}" width="40px"> <a href="">Email</a>
                                </li>
                                <li>
                                    <img src="{{ asset('assets/icon/tiktok.png') }}" width="40px"> <a href="">Tok Tok</a>
                                </li>
                                <li>
                                    <img src="{{ asset('assets/icon/phone.jpg') }}" width="40px"> <a href="">012 333 444 / 010 232 323</a>
                                </li>
                            </ul>
                        </div>
                    </div>
